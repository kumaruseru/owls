    ...
    const statItems = [
        {
            ...
            desc: "Total earnings",
            trend: "+12.5%", // Fake trend for demo
            trendUp: true
        },
        {
            title: "Total Orders",
        ...
        },
        {
            ...
            trend: stats?.pending_count ? `${stats.pending_count} waiting` : "All clear",
            trendUp: false
        },
    ];
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl shadow-2xl shadow-purple-900/5 overflow-hidden">
                        ...
                        {!isLoading && stats && (
                            <div className="p-4 border-t border-white/10 bg-black/20 flex items-center gap-2 text-xs text-neutral-500 justify-center">
                                ...
                                <span>You have <span className="text-white font-bold">{stats.pending_count}</span> pending orders requiring attention.</span>
                            </div>
                        )}
                    </div>
                </div>
